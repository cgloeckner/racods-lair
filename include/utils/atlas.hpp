...
struct Chunk final {
	 ...
	 */
	Chunk(Key const& key, sf::Image&& image, sf::IntRect const& bounds,
...
class AtlasGenerator final {
  ...
  public:
	 ...
	 * @param min_step determines the minimum step range for searching a free
	 * spot
	...
	bool generate(sf::Vector2u const& min_step, std::size_t size,
		Atlas<Key, HashFunc>& atlas);
};

}  // ::sfext

// include implementation details
#include <utils/atlas.inl>
